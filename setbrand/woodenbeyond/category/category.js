...
function renderCategory() {
    ...
    const filteredRaw = products.filter(item => {
        ...
        const isResinRelated = allMetadata.includes('mdf');
    ...
    grid.innerHTML = finalItems.map(product => {
        ...
        const wpMessage = encodeURIComponent(`Hi Wooden beyonds! I'm inquiring about: ${product.name} (ID: ${product.id}). Is this available?`);
